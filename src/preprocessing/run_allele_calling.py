    ...
    if 'cluster' in sys.argv:
        ...
        for i_gene in Itop:
            ...
            for iv in SP.nonzero(Ivar)[0]:
                ...
                _C = L.shape[0]
                count.append(_C)
                P = SP.array([(L==_alleles[0]).sum(),(L==_alleles[1]).sum()],dtype='float')#how many to each allele for each gene
