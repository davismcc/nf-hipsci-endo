# davismcc/nf-hipsci-endo: Reference Genomes Configuration

The davismcc/nf-hipsci-endo pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```nextflow
includeConfig '/path/to/davismcc/nf-hipsci-endo/conf/igenomes.config'
```
