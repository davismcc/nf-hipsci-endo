# davismcc/nf-hipsci-endo Installation

To start using the davismcc/nf-hipsci-endo pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `davismcc/nf-hipsci-endo` is specified as the pipeline name.
...
```bash
wget https://github.com/davismcc/nf-hipsci-endo/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/davismcc-nf-hipsci-endo-master
```
